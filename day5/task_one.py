    ...
    with open(data_file, "r") as file:
        ...
        for line in file:
            ...
            if 'move' in line:
                ...
                array[array_index_to_move_to] = array[array_index_to_move_from][0:amount_to_move][::-1] + array[array_index_to_move_to] 
                array[array_index_to_move_from] = array[array_index_to_move_from][amount_to_move:]
